...
export const CURRENCIES = {
  INR: { code: 'INR', symbol: '₹', name: 'Indian Rupee',      locale: 'en-IN', rateToInr: 1,    cardMin: 50,  chips: [1, 11, 51, 101, 501, 1000, 5000, 25000] },
  USD: { code: 'USD', symbol: '$', name: 'US Dollar',         locale: 'en-US', rateToInr: 83,   cardMin: 1,   chips: [1, 2, 5, 10, 25, 50, 100, 500] },
  EUR: { code: 'EUR', symbol: '€', name: 'Euro',              locale: 'de-DE', rateToInr: 90,   cardMin: 1,   chips: [1, 2, 5, 10, 25, 50, 100, 500] },
  GBP: { code: 'GBP', symbol: '£', name: 'British Pound',     locale: 'en-GB', rateToInr: 105,  cardMin: 1,   chips: [1, 2, 5, 10, 20, 50, 100, 500] },
  AED: { code: 'AED', symbol: 'AED ', name: 'UAE Dirham',     locale: 'en-AE', rateToInr: 22.6, cardMin: 3,   chips: [3, 5, 10, 25, 50, 100, 250, 1000] },
  SGD: { code: 'SGD', symbol: 'S$', name: 'Singapore Dollar', locale: 'en-SG', rateToInr: 61,   cardMin: 1,   chips: [1, 2, 5, 10, 25, 50, 100, 500] },
  AUD: { code: 'AUD', symbol: 'A$', name: 'Australian Dollar',locale: 'en-AU', rateToInr: 55,   cardMin: 1,   chips: [1, 2, 5, 10, 25, 50, 100, 500] },
  CAD: { code: 'CAD', symbol: 'C$', name: 'Canadian Dollar',  locale: 'en-CA', rateToInr: 61,   cardMin: 1,   chips: [1, 2, 5, 10, 25, 50, 100, 500] },
  JPY: { code: 'JPY', symbol: '¥', name: 'Japanese Yen',      locale: 'ja-JP', rateToInr: 0.55, cardMin: 100, chips: [100, 200, 500, 1000, 2500, 5000, 10000, 50000], zeroDecimal: true },
};
...
// Stripe smallest unit for the charge currency
export function toMinorUnits(amount, code) {
  const c = currencyOf(code);
  const n = Math.floor(Number(amount));
  return c.zeroDecimal ? n : n * 100;
}
